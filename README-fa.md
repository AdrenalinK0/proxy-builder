# Chain Proxy Builder (سازنده پراکسی زنجیره‌ای)
...
- **CSS3**: متغیرهای کاربردی، طراحی گلس‌مورفیسم (Glassmorphism) و انیمیشن‌ها.
- **JavaScript**: منطق اصلی پردازش و استخراج URL و تولید JSON نهایی.
